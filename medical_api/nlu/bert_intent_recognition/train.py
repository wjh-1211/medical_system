...
class_nums = 13
maxlen = 60
batch_size = 8 #传入的文本数量

config_path='D:/DeskTop/roberta/bert_config_rbt3.json'
checkpoint_path='D:/DeskTop/roberta/bert_model.ckpt'
dict_path = 'D:/DeskTop/roberta/vocab.txt'
